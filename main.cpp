...
int main(int argc, const char** argv) {
  ...
  GLFWwindow* window = glfwCreateWindow(2000, 900, "Demo", NULL, NULL);
...
//    std::cout << "Camera azimuth: " << cam.azimuth << ", elevation: " << cam.elevation << ", distance: " << cam.distance;
//    std::cout << ", lookat: " << cam.lookat[0] << ", " << cam.lookat[1] << ", " << cam.lookat[2] << std::endl;
